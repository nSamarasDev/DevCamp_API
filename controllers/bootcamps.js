...
//@access  Public
// We have access to advancedResults because this route is using that middleware.
...
exports.bootcampPhotoUpload = asyncHandler(async (req, res, next) => {
  ...
  // Make sure the image is a photo = mimetype for image or pdf
